...
async def claim_and_enqueue_one_outbox_owning_txn(
    *,
...
async def claim_and_enqueue_ready_batch_owning_txn(
    *,
    session: AsyncSession,
...
async def reclaim_and_enqueue_expired_leases_owning_txn(
    *,
    session: AsyncSession,
    job_manager: JobManagerProtocol,
    user_id: UUID,
